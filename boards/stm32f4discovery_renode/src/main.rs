...
static mut CHIP: Option<&'static stm32f407zg::chip::Stm32f4xx> = None;
...
unsafe fn setup_dma() {
    // use stm32f407zg::dma1::{Dma1Peripheral, DMA1};
    // use stm32f407zg::usart;
    // use stm32f407zg::usart::USART2;
...
unsafe fn set_pin_primary_functions() {
    ...
    use stm32f407zg::exti::{LineId, EXTI};
    use stm32f407zg::gpio::{AlternateFunction, Mode, PinId, PortId, PORT};
    use stm32f407zg::syscfg::SYSCFG;
    ...
    // cortexm4::nvic::Nvic::new(stm32f407zg::nvic::EXTI0).enable();
    ...
    cortexm4::nvic::Nvic::new(stm32f407zg::nvic::EXTI1).enable();
    ...
    cortexm4::nvic::Nvic::new(stm32f407zg::nvic::EXTI15_10).enable();
    ...
    stm32f407zg::i2c::I2C1.enable_clock();
    stm32f407zg::i2c::I2C1.set_speed(stm32f407zg::i2c::I2CSpeed::Speed100k, 16);
    ...
    PinId::PA01.get_pin().as_ref().map(|pin| {
        pin.set_mode(stm32f407zg::gpio::Mode::AnalogMode);
    });
    ...
    cortexm4::nvic::Nvic::new(stm32f407zg::nvic::EXTI9_5).enable();
    ...
    //         pin.set_mode(stm32f407zg::gpio::Mode::AlternateFunctionMode);
    //         pin.set_floating_state(gpio::FloatingState::PullUp);
    //         pin.set_speed();
    //         pin.set_alternate_function(stm32f407zg::gpio::AlternateFunction::AF12);
    //     });
    // }
...
unsafe fn setup_peripherals() {
    use stm32f407zg::tim2::TIM2;

    // USART2 IRQn is 38
    cortexm4::nvic::Nvic::new(stm32f407zg::nvic::USART2).enable();

    // TIM2 IRQn is 28
    TIM2.enable_clock();
    TIM2.start();
    cortexm4::nvic::Nvic::new(stm32f407zg::nvic::TIM2).enable();
...
pub unsafe fn reset_handler() {
    ...
    let chip = static_init!(
        stm32f407zg::chip::Stm32f4xx,
        stm32f407zg::chip::Stm32f4xx::new()
    );
    CHIP = Some(chip);
    ...
    stm32f407zg::usart::USART2.enable_clock();
    let uart_mux = components::console::UartMuxComponent::new(
        &stm32f407zg::usart::USART2,
        115200,
    ...
    let led = components::led::LedsComponent::new(components::led_component_helper!(
        ...
        (
            stm32f407zg::gpio::PinId::PD12.get_pin().as_ref().unwrap(),
            kernel::hil::gpio::ActivationMode::ActiveHigh
        ),
        (
            stm32f407zg::gpio::PinId::PD13.get_pin().as_ref().unwrap(),
            kernel::hil::gpio::ActivationMode::ActiveHigh
        ),
        (
            stm32f407zg::gpio::PinId::PD14.get_pin().as_ref().unwrap(),
            kernel::hil::gpio::ActivationMode::ActiveHigh
        ),
        (
            stm32f407zg::gpio::PinId::PD15.get_pin().as_ref().unwrap(),
            kernel::hil::gpio::ActivationMode::ActiveHigh
        )
    ))
    ...
    let tim2 = &stm32f407zg::tim2::TIM2;
    let mux_alarm = components::alarm::AlarmMuxComponent::new(tim2).finalize(
        components::alarm_mux_component_helper!(stm32f407zg::tim2::Tim2),
    );

    let alarm = components::alarm::AlarmDriverComponent::new(board_kernel, mux_alarm)
        .finalize(components::alarm_component_helper!(stm32f407zg::tim2::Tim2));
    ...
    let gpio = GpioComponent::new(
        ...
        components::gpio_component_helper!(
            stm32f407zg::gpio::Pin,
            // Arduino like RX/TX
            0 => stm32f407zg::gpio::PinId::PG09.get_pin().as_ref().unwrap(), //D0
            1 => stm32f407zg::gpio::PinId::PG14.get_pin().as_ref().unwrap(), //D1
            2 => stm32f407zg::gpio::PinId::PG13.get_pin().as_ref().unwrap(), //D2
            3 => stm32f407zg::gpio::PinId::PF04.get_pin().as_ref().unwrap(), //D3
            4 => stm32f407zg::gpio::PinId::PG12.get_pin().as_ref().unwrap(), //D4
            5 => stm32f407zg::gpio::PinId::PF10.get_pin().as_ref().unwrap(), //D5
            6 => stm32f407zg::gpio::PinId::PF03.get_pin().as_ref().unwrap(), //D6
            7 => stm32f407zg::gpio::PinId::PG11.get_pin().as_ref().unwrap(), //D7
            8 => stm32f407zg::gpio::PinId::PG10.get_pin().as_ref().unwrap(), //D8
            9 => stm32f407zg::gpio::PinId::PB08.get_pin().as_ref().unwrap(), //D9
            // SPI Pins
            10 => stm32f407zg::gpio::PinId::PA15.get_pin().as_ref().unwrap(), //D10
            11 => stm32f407zg::gpio::PinId::PA07.get_pin().as_ref().unwrap(),  //D11
            12 => stm32f407zg::gpio::PinId::PA06.get_pin().as_ref().unwrap(),  //D12
            13 => stm32f407zg::gpio::PinId::PA15.get_pin().as_ref().unwrap()  //D13

            // ADC Pins
            // Enable the to use the ADC pins as GPIO
            // 14 => stm32f407zg::gpio::PinId::PA01.get_pin().as_ref().unwrap(), //A0
            // 15 => stm32f407zg::gpio::PinId::PC01.get_pin().as_ref().unwrap(), //A1
            // 16 => stm32f407zg::gpio::PinId::PC03.get_pin().as_ref().unwrap(), //A2
            // 17 => stm32f407zg::gpio::PinId::PC04.get_pin().as_ref().unwrap(), //A3
            // 19 => stm32f407zg::gpio::PinId::PC05.get_pin().as_ref().unwrap(), //A4
            // 20 => stm32f407zg::gpio::PinId::PB00.get_pin().as_ref().unwrap() //A5
        ),
    )
